...
var WeatherComponent = (function () {
    ...
    WeatherComponent.prototype.getLocationName = function () {
        ...
        this.service.getLocationName(this.pos.coords.latitude, this.pos.coords.longitude)
            ...
            console.log("Current place: " + _this.currentLocation);
        });
    };
    ...
    WeatherComponent.prototype.setStyles = function () {
        if (this.weatherData.icon) {
            this.icons.color = constants_1.default.WEATHER_COLORS[this.weatherData.icon]["color"];
            return constants_1.default.WEATHER_COLORS[this.weatherData.icon];
        }
        else {
            this.icons.color = constants_1.default.WEATHER_COLORS["default"]["color"];
            return constants_1.default.WEATHER_COLORS["default"];
        }
    };
